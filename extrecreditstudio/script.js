(function () {
    ...
    const p1GoalValue = document.querySelector('#p1-goal-value');
    const p2GoalValue = document.querySelector('#p2-goal-value');
    ...
    function updateGoalDisplay() {
        const p1Remaining = Math.max(0, gameData.gameEnd - gameData.score[0]);
        const p2Remaining = Math.max(0, gameData.gameEnd - gameData.score[1]);

        p1GoalValue.textContent = p1Remaining;
        p2GoalValue.textContent = p2Remaining;
    }
